        ...
        <div class="card-body">
            <div class="border rounded p-3 bg-light small mb-3">
                ...
                <p class="mb-2">
                    ...
                    phiên nằm trong khung lịch của dòng lịch có <strong>cùng mã GV</strong> khi
                    ...
                    Một ngày có thể nhiều khung — chỉ so với dòng lịch <strong>trùng mã giáo viên</strong> trong ngày đó.
                </p>
                <p class="mb-0">
